...
func adicionar_item_ao_slot(item_base : ItemBase, quantidade : int):
	...
	BusSignal.emit_signal("att_inventario_visual",index_do_slot, item_atual_do_slot.icone_item, quantidade_atual_no_slot)
...
func remover_item_do_slot():
	...
	BusSignal.emit_signal("att_inventario_visual",index_do_slot, null , 0)
